            ...
            <ul className="space-y-4">
                ...
                <li>
                    <Link href="/week-7" legacyBehavior>
                        <a className="text-xl text-white-400">Week 7 Assignment</a>
                    </Link>
                </li>
                <li>
                    <Link href="/week-8" legacyBehavior>
                        <a className="text-xl text-white-400">Week 8 Assignment</a>
                    </Link>
                </li>
                <li>
                <Link href="/week-9" legacyBehavior>
                        <a className="text-xl text-white-400">Week 9 Assignment</a>
                    </Link>
                </li>
            </ul>
        </main>
